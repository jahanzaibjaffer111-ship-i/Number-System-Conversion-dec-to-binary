...
public class dec_to_binary_conversion_through_string_plus_function
{
    ...
    public static String noSystemConversion(String ans , int a)
    {
        while(a>=1)
        {
            if(a%2==0)
